  ...
  return (
    <Page size="A4" style={commonStyles.page}>
        ...
        {recommendations.map((rec, index) => (
          <View key={index} style={styles.recommendationCard}>
            ...
            <View style={{ marginTop: 8 }}>
              <Text style={[commonStyles.small, { fontFamily: 'Helvetica-Bold', marginBottom: 4 }]}>
                Recommended Actions:
              </Text>
      ...
      <View style={commonStyles.section}>
        ...
        <View style={styles.readinessBox}>
          <View style={styles.readinessRow}>
            ...
            <Text style={[commonStyles.small, { fontFamily: 'Helvetica-Bold' }]}>
      ...
      <View style={styles.nextStepsBox}>
        ...
        <Text style={[commonStyles.body, { fontFamily: 'Helvetica-Bold', color: colors.accent }]}>
          {nextSteps.cta}
        </Text>
      </View>
