      ...
      <View style={commonStyles.section}>
        ...
        <Card>
          ...
          <View style={[styles.benchmarkRow, { backgroundColor: colors.surface }]}>
            <Text style={[styles.benchmarkLabel, { fontFamily: 'Helvetica', fontWeight: 700 }]}>Dimension</Text>
            <Text style={[styles.benchmarkValue, { fontFamily: 'Helvetica', fontWeight: 700 }]}>Your Score</Text>
            <Text style={[styles.benchmarkValue, { fontFamily: 'Helvetica', fontWeight: 700 }]}>Benchmark</Text>
            <Text style={[styles.benchmarkGap, { fontFamily: 'Helvetica', fontWeight: 700 }]}>Gap</Text>
          </View>
